...
const EditPositionModal = ({ isOpen, onClose, onSave, onDelete, position }) => {
  ...
  const validateForm = () => {
    ...
    if (!positionData.position_name.trim()) {
  ...
  const handleSubmit = (e) => {
    ...
    onSave(position.id, positionData);
  };

  const handleDelete = () => {
    if (window.confirm(`Are you sure you want to delete the position "${position.position_name}"?`)) {
